 ...
 */
@property (retain, atomic) NSString *typeName;
 ...
 */
@property (retain, atomic, readonly) NSArray *fieldTypes;
 ...
 */
@property (retain, atomic) kfxKEDImagePerfectionProfile *imagePerfectionProfile;
...
/**
 ...
 @deprecated Deprecated in 3.3.
 */
@property (retain, atomic) kfxKEDBasicSettingsProfile *basicSettingsProfile;
...
@property (retain, atomic) KFXImageProcessorConfiguration *imageProcessorConfiguration;
