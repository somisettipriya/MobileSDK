 ...
 */
@property (assign, nonatomic) KEDBarcodeTypes type;
...
/**
 ...
 @param dir is an enum KEDBarcodeDirections setting that you want to evauluate.
 @return A string representing the setting supplied.
 */
...
/**
 ...
 @param format is an enum KEDBarcodeDataFormats setting that you want to evauluate.
 @return A string representing the setting supplied.
 */
