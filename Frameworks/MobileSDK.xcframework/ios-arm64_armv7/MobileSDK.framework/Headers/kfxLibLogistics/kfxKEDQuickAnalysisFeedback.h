...
//! Image may be blurry
/**
 The image processor sets this to true if the input image may be blurry.
 Default: false;
 */
...
/**
 The likely cause is that the flash is on, or an extremely bright light sits directly above
 the location where the image was taken. A dirty lens can also cause some of the same "washout"
 Default: false;
 */
...
/**
 The image processor sets this to true if it detects that the input image may be poorly lit.
...
/**
 The image processor sets this to true if the input image have been detected with glare.
 Default: false;
 */
@property bool isGlareDetected;


// ==========================================================
//! Image may be overly skewed
/**
 The image processor sets this to true if the input image may be overly skewed.
 Default: false;
 */
@property bool isOverlySkewed;

// ==========================================================
//! Image may have shadows
/**
 The image processor sets this to true if the input image may have shadows.
 Default: false;
 */
@property bool isShadowed;


// ==========================================================
//! Image may be missing borders
/**
 The image processor sets this to true if the input image may be missing borders.
 Default: false;
 */
@property bool isMissingBorders;


// ==========================================================
//! Image may have uneven or low contrast background
/**
 The image processor sets this to true if the input image may have uneven or low
 contrast background.
 
 Default: false;
 */
@property bool isLowContrastBackground;
