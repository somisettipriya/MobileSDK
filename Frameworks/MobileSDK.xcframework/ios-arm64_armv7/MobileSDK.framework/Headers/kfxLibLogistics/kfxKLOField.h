 ...
 */
@property (retain, atomic, readonly) kfxKLOFieldType *fieldType;
 ...
 */
@property (retain, atomic, readonly) NSString *value;
 ...
 */
@property (assign, atomic, readonly) bool valid;
 ...
 */
@property (retain, atomic, readonly) NSString *errorDescription;
...
/**
 ...
 @endcode
 */
- (id) initWithFieldTypeObject: (kfxKLOFieldType *)fieldType andDocumentID : (NSString*) documentID;
 ...
 */
- (void) updateFieldProperties : (NSString *) value andIsValid : (bool) isValid andErrorDescription : (NSString *)errorDescription;
