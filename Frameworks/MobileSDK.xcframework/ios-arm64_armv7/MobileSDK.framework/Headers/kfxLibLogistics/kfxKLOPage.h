 ...
 */
@property (retain, atomic, readonly) NSArray *images;
 ...
 */
@property (retain, atomic, readonly) NSString *pageID;
...
//! DocumentID object.
/**
 The DocumentID is set when the page is added to a document object.
 */
@property (retain, atomic, readonly) NSString * documentID;
