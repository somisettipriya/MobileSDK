 ...
 */
@property (assign, nonatomic) KEDClassifierOrientation orientation;
...
/**
 ...
 There are no imposed range limits, but typically the score is between +/- 2.0.
...
/**
 ...
 @param orientation is an enum KEDClassifierOrientation setting that you want to evauluate.
