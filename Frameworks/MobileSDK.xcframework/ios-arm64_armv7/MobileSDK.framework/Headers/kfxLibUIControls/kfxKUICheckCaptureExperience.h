...
#import <kfxLibUIControls/kfxKUICheckCaptureExperienceCriteriaHolder.h>
...
/**
 ...
 guide the user to take a clear, legible and optimally zoomed in photo of a check.
 */
@interface kfxKUICheckCaptureExperience : kfxKUIDocumentBaseCaptureExperience
 ...
 */
- (instancetype)initWithCaptureControl:(kfxKUIImageCaptureControl*)captureControl criteria:(kfxKUICheckCaptureExperienceCriteriaHolder*)criteria;
 ...
 */
@property (nonatomic, strong) kfxKUICheckCaptureExperienceCriteriaHolder* checkCriteria;
